...
import EllipseLoading from "../components/loading/EllipseLoading";
...
export default function LoginPage() {
  ...
  //   return router.push(`/ia-hubs/customers`);
  // }
  ...
  return (
    <>
      <div className="flex m-auto mt-14 max-w-md border shadow min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <form className="space-y-6" onSubmit={submitFormData}>
            <div>
              ...
              <div className="text-red-500 text-xs h-2 mt-1">
                {emptyInput && !formData.identifier ? (
                  <p>field required*</p>
                ) : (
                  ""
                )}
            ...
            <div>
              ...
              <div className="text-red-500 text-xs h-2 mt-1">
                {emptyInput && !formData.password ? <p>field required*</p> : ""}
              </div>
            </div>
            ...
            <div>
              ...
              >
                {isLoading ? <SignInSpinner /> : isLoggedIn ? <span>Login successful</span> : <span>Sign in</span>}
              </button>
            </div>
          </form>
        </div>
